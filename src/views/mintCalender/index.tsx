...
export const MintCalendar = () => {
          ...
          <div className="flex flex-col m-auto ml-2 bg-gray-900">
            ...
            <div className="flex">
              ...
              <span className="my-auto text-xs">
                {dayjs.unix(mint?.mint_time).format("HH:mm")}
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <Page className="h-screen-no-nav mint-padding">
      <>
        {mintEvents ? (
          <FullCalendar
            slotEventOverlap={false}
            eventClassNames={
              "bg-gray-transparent  border-none cursor-pointer whitespace-normal"
            }
            headerToolbar={{
          ...
          >
            <div className="flex flex-col bg-gray-900 pt-4 rounded-md overflow-hidden">
              <div className="flex flex-col px-4 mx-auto md:px-10">
                <span className="text-3xl mx-auto my-2 px-5">
                  {selectedEvent.name}
                </span>

                <div className="rounded-md mx-auto my-4 h-72 w-72 overflow-hidden">
                  <img
                    src={selectedEvent.thumbnail_public_url}
                    className="h-72 w-72"
                  />
                </div>
              ...
              <div className="flex flex-col py-4 pb-10 px-10">
                <div className="flex">
                  ...
                  <p className="text-base text-white-300 m-1">
                  ...
                  />
                  <p className="text-base text-white-300 m-1">
                    {selectedEvent?.mint_price || "-"} SOL
                  </p>
                </div>
                <span className="text-xs mx-2">
                  Minting at{" "}
                  {dayjs.unix(selectedEvent.mint_time).format("HH:mm")} on{" "}
