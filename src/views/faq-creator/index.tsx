    ...
    const getPost = async () => {
      try {
        const res = await fetch(
          `https://blog.digitaleyes.market/wp-json/wp/v2/pages/293?&_embed`
        );
    ...
    const getSeo = async () => {
      try {
        const head = await fetch(
          `https://blog.digitaleyes.market/wp-json/rankmath/v1/getHead?url=https://blog.digitaleyes.market/creator-faqs`
        )
