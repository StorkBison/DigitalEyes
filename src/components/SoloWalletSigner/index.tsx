      ...
      {error && (
        <div className="flex-1 justify-center pt-20">
          <div className="w-48 mx-auto">
            <div className="text-3xl text-center my-4 text-red-500">
              an error occured{" "}
            </div>
      ...
      {!isLoading && !success && !error && wallet?.publicKey && (
        <div>
          ...
          <div className="text-md text-center my-2">
            To continue you must authenticate your wallet for use with
            Digitaleyes{" "}
          </div>
          <div className="text-xs text-center my-2">
            don't worry! this is free & we do not store or share any of your
            personal information.{" "}
          </div>
          <div className="text-xs text-center my-2">
            this authentication is what helps us ensure your ownership of your
            account!{" "}
          </div>
          <div className="flex justify-center my-10">
