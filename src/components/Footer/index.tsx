    ...
    >
      ...
      <div className="flex gap-20 flex-col flex-wrap justify-start md:flex-row">
        <div className="flex flex-col">
          ...
          <FooterLink href="/explore">Collections</FooterLink>
          <FooterLink href="/launchpad/featured">Launchpad</FooterLink>
          <a href="/buyer-seller-faqs" rel="noreferrer" className="mb-1 text-sm font-regular text-gray-400 hover:text-white transition 250 ease-in-out opacity-70 hover:opacity-100" style={{ color: isProfilePage && profileTheme ? profileTheme.footerForeground : "" }}>FAQs: Buyer/Seller</a>
          <a href="/creator-faqs" rel="noreferrer" className="mb-1 text-sm font-regular text-gray-400 hover:text-white transition 250 ease-in-out opacity-70 hover:opacity-100" style={{ color: isProfilePage && profileTheme ? profileTheme.footerForeground : "" }}>FAQs: Creator</a>
          <a href="/buyer-seller-guides" rel="noreferrer" className="mb-1 text-sm font-regular text-gray-400 hover:text-white transition 250 ease-in-out opacity-70 hover:opacity-100" style={{ color: isProfilePage && profileTheme ? profileTheme.footerForeground : "" }}>Guides: Buyer/Seller</a>
          <a href="/creator-guides" rel="noreferrer" className="mb-1 text-sm font-regular text-gray-400 hover:text-white transition 250 ease-in-out opacity-70 hover:opacity-100" style={{ color: isProfilePage && profileTheme ? profileTheme.footerForeground : "" }}>Guides: Creator</a>
