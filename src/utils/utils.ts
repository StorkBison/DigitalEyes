...
export const checkIfContainsSpaces = (payload: string): any => {
  if (payload) {
    for (let i = 0; i < payload.length; i++) {
      ...
      if (element !== "%20" && element !== "-" && element !== "_") {
        return true
      }
    }
    return true
...
export const formatToHyphen = (payload: string): any => {
  let result = []
  if (payload) {
    for (let i = 0; i < payload.length; i++) {
      const element = payload[i]
...
export const formatToSpaces = (payload: string): any => {
  let result = []
  if (payload) {
    for (let i = 0; i < payload.length; i++) {
      const element = payload[i]
