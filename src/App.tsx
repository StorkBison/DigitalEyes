...
import { LaunchPadProjectView } from "./components/LaunchPadV2/LaunchPadProject"
                              ...
                              <AccountsProvider>
                                <Layout>
                                  <Switch>
                                    ...
                                    {/* <Redirect
                                      from={`${ROUTES.COLLECTIONS}/:collectionName?`}
                                      to={`${ROUTES.COLLECTIONS}/:collectionName?`}
                                    /> */}
                                    <Route
                                      path={`${ROUTES.COLLECTIONS}/:collectionName?`}
                                    ...
                                    <Route
                                      exact
                                      path={ROUTES.CREATOR_FAQS}
                                      children={<FaqCreatorView />}
                                    />
                                    <Route
                                      exact
                                    ...
                                    <Route
                                      ...
                                      //component={LaunchPadProjectView}
                                    ...
                                    <Route
                                      exact
                                      path={`${ROUTES.SOLO_ITEM}/:mint?/:wallet?`}
                                      children={<ItemView />}
                                    />
                                    <Route
                                      exact
